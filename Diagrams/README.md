...
![Class diagram](https://github.com/s1ovak/PhoneShop/blob/master/Diagrams/Class/Class%20diagram.png)
Для упрощения общей схемы диаграмма была разделена на условные уровни:
* Model level - классы сущностей, используемых при взаимодействии с базой данных (класс соответсвует таблице в базе).
* Dao level - классы уровня Data Access. Используются для взаимодествия с базой данных.
